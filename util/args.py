...
def config_args(callback=None):
    ...
    parser.add_argument("--lr1", type=float, default=22e-3, help='the learning rate for the rgb texture (pre-sh)')
    parser.add_argument("--lr2", type=float, default=8e-4, help='the learning rate for the point position (pre-sh)')
    parser.add_argument("--lr3", type=float, default=22-3, help='the learning rate for the rgb texture (post-sh)')
    parser.add_argument("--lr4", type=float, default=8e-4, help='the learning rate for the point position (post-sh)')
    parser.add_argument("--lr5", type=float, default=22e-3, help='the learning rate for the rgb texture (frame to frame)')
    parser.add_argument("--lr6", type=float, default=8e-4, help='the learning rate for the point position (frame to frame)')
    ...
    # Extra args added for st-nerf
    parser.add_argument("--frame_id", type=int, default=0,
                        help='frame to use')
    parser.add_argument("--included_layers", type=str, default="1",
                        help='which layers to include among dataset')
